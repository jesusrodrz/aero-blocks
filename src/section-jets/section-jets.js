 ...
 */
registerBlockType('asb/section-jets', {
  // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
  title: __('Section - Jets'), // Block title.
  icon: <Icon icon="i-airplane" />, // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
