 ...
 */
registerBlockType('asb/section-parallax', {
  // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
  title: __('Section - Parrallax'), // Block title.
  icon: <Icon icon="i-image" />, // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
